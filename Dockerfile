...
##   $ docker build -t php-for-10-0-1-92-1-27-phpcr-shell .
##
## RUNNING
##   $ docker run -p 9000:9000 php-for-10-0-1-92-1-27-phpcr-shell
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="lbfk0je" \
    STACKSMITH_STACK_NAME="PHP for 10-0-1-92-1-27/phpcr-shell" \
